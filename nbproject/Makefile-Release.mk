...
${OBJECTDIR}/GraphHNMain.o: GraphHNMain.cu 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GraphHNMain.o GraphHNMain.cu

${OBJECTDIR}/GraphHullNumber.o: GraphHullNumber.cu 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GraphHullNumber.o GraphHullNumber.cu

${OBJECTDIR}/UndirectedSparseGraph.o: UndirectedSparseGraph.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UndirectedSparseGraph.o UndirectedSparseGraph.cpp
